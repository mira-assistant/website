        ...
        <>
          ...
          <div className="space-y-2.5">
            <button
              ...
              disabled={loading || !window.electronAPI}
              title={
                window.electronAPI
                  ? undefined
                  : 'Google sign-in uses the Mira desktop app (system browser OAuth).'
              }
            ...
            <button
              ...
              title={
                window.electronAPI
                  ? undefined
                  : 'GitHub sign-in uses the Mira desktop app (system browser OAuth).'
              }
          ...
          {!window.electronAPI ? (
            <p className="mt-3 text-center text-xs leading-relaxed text-slate-500">
              Google and GitHub use a system-browser OAuth flow wired through the{' '}
              <span className="font-medium text-slate-600">Mira desktop app</span>. In the browser,
